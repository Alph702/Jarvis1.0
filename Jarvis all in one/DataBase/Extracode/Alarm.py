...
extracted_time = open("F:\\Code\\Jarvis all in one\\Data.txt",'rt')
time = extracted_time.read()
Time = str(time)
delete_time = open("F:\\Code\\Jarvis all in one\\Data.txt","r+")
...
def RingerNow(time):
    ...
    while True:
        ...
        if current_time == Alarm_Time:
            ...
            playsound("F:\\Code\\Jarvis all in one\\DataBase\\Sounds\\1.mp3")
